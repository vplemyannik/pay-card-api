...
require (
	...
	github.com/ozonmp/pay-card-api/pkg/pay-card-events v0.0.0-00010101000000-000000000000
...
replace github.com/ozonmp/pay-card-api/pkg/pay-card-events => ./pkg/pay-card-events
