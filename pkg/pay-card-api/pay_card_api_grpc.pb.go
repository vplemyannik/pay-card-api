...
type PayCardApiServiceClient interface {
	...
	ListCard(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListCardV1Response, error)
}
...
func (c *payCardApiServiceClient) ListCard(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListCardV1Response, error) {
...
type PayCardApiServiceServer interface {
	...
	ListCard(context.Context, *emptypb.Empty) (*ListCardV1Response, error)
...
func (UnimplementedPayCardApiServiceServer) ListCard(context.Context, *emptypb.Empty) (*ListCardV1Response, error) {
...
func _PayCardApiService_ListCard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PayCardApiServiceServer).ListCard(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
